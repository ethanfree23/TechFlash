    ...
    return (
      <div className="flex flex-col items-end gap-1 shrink-0">
        ...
        {display.hasCounterPending && (
          <span
            className="text-[10px] font-semibold uppercase tracking-wide text-orange-800 bg-orange-50 border border-orange-200/80 px-1.5 py-0.5 rounded-full whitespace-nowrap"
